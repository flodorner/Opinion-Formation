...
for i in range(25):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"id_nobots"+str(i))
    plt.close()
...
for i in range(25):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"nobots_eval_extreme"+str(i))
    plt.close()
...
for i in range(25):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"id_singlebots_50"+str(i))
    plt.close()
...
for i in range(25):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"id_singlebots_5"+str(i))
    plt.close()
...
for i in range(25):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"eval_extreme_5neutral"+str(i))
    plt.close()
...
for i in range(25):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"eval_extreme_100neutral"+str(i))
    plt.close()
...
for i in range(25):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"id_bots_edge_bottom"+str(i))
    plt.close()
...
for i in range(25):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"id_bots_edge"+str(i))
    plt.close()
...
for i in range(25):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"id_bots_edge_top"+str(i))
    plt.close()
...
for i in range(50):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"id_edge_eps1_"+str(i))
    plt.close()
...
for i in range(50):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"id_edge_eps1_bots"+str(i))
    plt.close()
...
for i in range(50):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"id_edge_eps1_bots_seeking"+str(i))
    plt.close()
...
for i in range(50):
    ...
    plt.ylim(-1.1, 1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder +  "id_edge_eps1_200bots" + str(i))
    plt.close()
...
for i in range(50):
    ...
    plt.ylim(-1.1, 1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder +  "id_edge_eps1_bots_seeking_200bots" + str(i))
    plt.close()
...
for i in range(50):
    ...
    plt.ylim(-1.1,1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder+"eval_extreme_edge_eps06"+str(i))
    plt.close()
...
for i in range(50):
    ...
    plt.ylim(-1.1, 1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder +  "eval_extreme_edge_eps06_200neutral" + str(i))
    plt.close()
...
for i in range(50):
    ...
    plt.ylim(-1.1, 1.1)
    plt.xlim(-1.1, 1.1)
    plt.savefig(image_folder +  "eval_extreme_edge_eps06_200neutral_seeking" + str(i))
    plt.close()
