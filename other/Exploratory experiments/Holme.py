...
import cProfile
model_type="Holme"
loop = ("n_edges",np.arange(205,226,4,dtype=np.int))
kw = {"n_vertices": 100, "n_opinions": 2, "phi": 0.5}
cProfile.run("output = experiment_loop(kw,loop,metrics=metrics,n=10,model_type=model_type)",sort="cumtime")
