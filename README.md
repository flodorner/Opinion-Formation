...
Holme & Newman (2006) developed a opinion dynamics model that lets networks and opinions simultaneously influence each other. On the other hand, Schweighofer et al. (2020) devoloped a multiopinion dynamics model that can generate polarization, but does not account for the influence of network structures. Therefore, we want to study what effects network structures have on polarization dynamics. In addition, we are interested to see what effects the introduction of bots can have on a multidimensional opinion dynamics model that can generate polarization and acocunts for complex network structures.
...
> * How does the introdcution of a complex network influence the polarization dynamics model developed by Schweighofer et a. (2020)?
